...
<head  runat="server">
    ...
    <title>Forgot Password - Pages | NETFEB GLOBAL</title>

    <meta name="description" content="Achieve new heights of SUCCESS in life Start your on BUSINESS" />
    <meta name="keywords" content=" NETFEB GLOBAL, business NETFEB GLOBAL, login ">
    <!-- Canonical SEO -->
...
<body id="top" data-theme-color="color-yellow"  style="background-image:url(bg.jpg); background-size:cover; background-position:center">
 ...
 <!-- Content -->
            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                   <div class="card-body" style=" -webkit-box-shadow: 0px 0px 10px 5px rgba(255,255,255,1); -moz-box-shadow: 0px 0px 10px 5px rgba(255,255,255,1); box-shadow: 0px 0px 10px 5px #000000;">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="index.html" class="app-brand-link gap-2">
                                <span class="app-brand-logo demo ">
                                   ...
                                   <img src="Loginassets/img/logo/logo.png" width="30%" />
                        ...
                        <!-- /Logo -->
                        <%--<h4 class="mb-2">Welcome to NETFEB GLOBAL!  </h4>--%>
                        ...
                        <p class="text-center">
                            <span>Back To NETFEB GLOBAL?</span>
                            <a href="login.aspx">
                                <span>Login</span>
                            </a>
                        </p>
    ...
    <!-- / Content -->
<%-- <div class="buy-now">
        <a href="index.html" target="_blank" class="btn btn-danger btn-buy-now">Back To NETFEB GLOBAL</a>
    </div>--%>
