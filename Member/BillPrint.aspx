                                        ...
                                        <div class="col-12 col-lg-12">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <span class="text-600 text-110 text-blue align-middle">NEXGROW INDIA PVT. LTD.</span>
                                                </div>
                                                <div class="text-grey-m2">
                                                    <div class="my-1">
                                                        Lorem Ipsum is simply dummy text of the printing and typesetting industry.  Pin code - XXXXX<br />
                                                        <i class="fa fa-envelope fa-flip-horizontal text-secondary"></i><b class="text-600">info@nexgrow.live</b>
                                                    </div>
                                            ...
                                            <div class="row" style="margin-bottom: -19px;">
                                                ...
                                                <div class="text-black bgc-default-tp1 col-sm-12" style="background-color: rgb(217 222 225 / 92%)!important">
                                                    ...
                                                    <h6 class="card-title" style="text-align: right">For <b>NEXGROW INDIA PVT. LTD. </b></h6>
