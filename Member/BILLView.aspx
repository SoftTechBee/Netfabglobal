                                ...
                                <div class=" form-group row ">
                                    <div class="col-sm-6">
                                        <h8 class="card-title" style="font-size: 27px">
                                            <img src="../assets/images/logo-icon.png" width="35%" height="100%" /></h8>
                                    ...
                                    <div class="col-12 col-lg-12">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div>
                                                    ...
                                                    <span class="text-600 text-110 text-blue align-middle">NETFEB GLOBAL</span>
                                                </div>
                                                <div class="text-grey-m2">
                                                    <div class="my-1">
                                                        Lorem Ipsum is simply dummy text of the printing and typesetting industry.  Pin code - XXXXX<br />
                                                        <i class="fa fa-envelope fa-flip-horizontal text-secondary"></i><b class="text-600">info@netfabglobal.com</b>
                                                    </div>
                                        ...
                                        <div class="row" style="margin-bottom: -19px;">
                                            ...
                                            <div class="text-black bgc-default-tp1 col-sm-12" >
                                                ...
                                                <h6 class="card-title" style="text-align: right">For <b>NETFEB GLOBAL : </b></h6>
