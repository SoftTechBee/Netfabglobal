    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (SessionData.Get<string>("Newuser") != null)
        {
            try
            {
                ...
                myInput.Value = "https://netfabglobal.com/register.aspx?Sponsor=" + username + "&Side=Left";
                myInputRight.Value = "https://netfabglobal.com/register.aspx?Sponsor=" + username + "&Side=Right";
                lbreffsidLeft.Text = "https://netfabglobal.com/register.aspx?Sponsor=" + username+"&Side=Left";
                lbreffsidRight.Text = "https://netfabglobal.com/register.aspx?Sponsor=" + username + "&Side=Right";
                ...
                //lbActivedirect.Text = objdashboard.TotalActiveDirect(username);
                //lbinActivedirect.Text = objdashboard.TotalINActiveDirect(username);
              ...
              //  lbWithdrawdeposit.Text = objdashboard.DepositDebit(username, "Main Wallet");
               ...
               lbtotalrepurchase.Text = objdashboard.SelfBusiness(username);
                ...
                //   lbPrincipalwithdraw.Text = objdashboard.WithdrawType(username,"Approved", "PRINCIPLE INVESTMENT");


                lblGlobalLevel.Text = objdashboard.IncomeType(username, "GLOBALLEVEL");
                lblDirectRefer.Text = objdashboard.IncomeType(username, "DIRECT");
                lblExtraDirect.Text = objdashboard.IncomeType(username, "EXTRADIRECT");
                lblExtraTeam.Text = objdashboard.IncomeType(username, "TEAM");
                lblGlobalBox.Text = objdashboard.IncomeType(username, "GLOBALBOX");
                lblRoyalty.Text = objdashboard.IncomeType(username, "ROYALTY");
                lblSalary.Text = objdashboard.IncomeType(username, "SALARY");
                lblMatchingBinary.Text = objdashboard.IncomeType(username, "MATCHING");
                lblSponsorBinary.Text = objdashboard.IncomeType(username, "DIRECTMATCHING");
                lblRepurchase.Text = objdashboard.IncomeType(username, "Repurchase");

                
                

                //lbtotalbusiness.Text = objdashboard.TotalTeamBusnessleg(username, "A");
                //lbpowerleg.Text = objdashboard.TotalTeamBusnessleg(username, "P");
                //lbweakerleg.Text = objdashboard.TotalTeamBusnessleg(username, "W");
