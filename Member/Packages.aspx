      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="card  mb-4    shadow-lg" style="border:1px solid blue;" >
              ...
              <h6>₹ <asp:Label ID="txtbalance" runat="server" Text="0"></asp:Label></h6>
             ...
             <div class="card border-top border-4 border-primary">
               <div class="card-body p-4">
                ...
                <div class="pricing-content d-flex flex-column ">
                  <p>PV/BV : <asp:Label runat="server" ID="lblpv" CssClass="text-warning" Text='<%#Eval("PV") %>'></asp:Label>/<asp:Label runat="server" ID="lblbv"  CssClass="text-warning" Text='<%#Eval("BV") %>'></asp:Label></p>
